            ...
            if (step + 1) % args.gradient_accumulation_steps == 0:
                ...
                if args.local_rank in [-1, 0] and args.save_steps > 0 and global_step % args.save_steps == 0:
                    ...
                    if f1 > best_f1:
                        ...
                        output_dir = os.path.join(args.output_dir, "checkpoint-best_model")
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    # {'acc': precision, 'recall': recall, 'f1': f1}, class_info
...
def main():
    ...
    if args.local_rank == -1 or args.no_cuda:
        device = torch.device("cuda:7" if torch.cuda.is_available() and not args.no_cuda else "cpu")
